...
class Artist(db.Model):
    ...
    def __repr__(self):
        return f'<Artist {self.id} {self.name} in {self.city}>'
...
class Shows(db.Model):
    ...
    def __repr__(self):
      return f'<Show  artist-id:{self.artist_id},  venue-id:{self.venue_id} start-time:{self.start_time}>'
...
def show_venue(venue_id):
  ...
  data={
    ...
    "past_shows_count": len(list(filter(lambda x: x.start_time < datetime.now(), Shows.query.filter_by(venue_id=venue.id)))),
    "upcoming_shows_count":len(list(filter(lambda x: x.start_time > datetime.now(), Shows.query.filter_by(venue_id=venue.id)))),
  }
...
def show_artist(artist_id):
  ...
  data={
    ...
    "past_shows": pastshow_store,
    "upcoming_shows": upcomingshow_store,
    "past_shows_count": len(list(filter(lambda x: x.start_time < datetime.now(), Shows.query.filter_by(artist_id=artist.id)))),
    "upcoming_shows_count": len(list(filter(lambda x: x.start_time > datetime.now(), Shows.query.filter_by(artist_id=artist.id)))),
  }
